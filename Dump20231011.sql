...
CREATE TABLE `ro` (
  ...
  `Password` varchar(45) NOT NULL,
  `Post` varchar(45) NOT NULL,
  `Leave_Apllication` mediumblob,
  `Apllication_status` tinyint DEFAULT NULL,
  PRIMARY KEY (`Bankid`),
...
INSERT INTO `ro` VALUES ('Aditya Samapthkumar','Aditya1','NearIIT','Kanjur','9875641234','gf','hgf',NULL,NULL),('Prajjwal Pandey','Prajjwal1','Near Station','Kalyan','9879879879','wjhfkj','jwfgl',NULL,NULL);
...
-- Dump completed on 2023-10-11  0:55:00
